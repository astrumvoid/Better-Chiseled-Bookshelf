...
# Upcoming features
_Most of them are already implemented, I just need to make a config menu for it_
...
- **Normal Book Power**: Allows you to change how much power a single book is worth. Deafults to ~0.16 (a lot of six), since this multiplied by 6 is 1. 
...
### For Forge Users
This mod will not recive any future update for forge (will be changed to neoforge). The reasons is:
